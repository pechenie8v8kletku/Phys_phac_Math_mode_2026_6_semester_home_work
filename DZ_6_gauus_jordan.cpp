...
// задачи были с сайта онлайн курса, на выбор две алго ил алго+ контейнеры
// реализовать без for ну задача n^3 сложности  так что как не крути тут будет 3 цикла, в данном случае они замаскированы под transform and for each.
// Попросил переделать divide_row применить std::divides and std::bind вообще странное требование ибо лямбда функции получше, но да бог с ними,

//ÑËÎæíîñòü àëãîðèòìà Ãàóññà æàðäàíà O(n^3) òàê ÷òî òóò èëè ñêðûòî èëè ÿâíî áóäåò âèäíî 3 âëîæåííûõ öèêëà, ÷àñòü çäåñü çàìàñêèðîâàíà ïîä STL íî âñå åùå îñòàåòñÿ öèêëîì
